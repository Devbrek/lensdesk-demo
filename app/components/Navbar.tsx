...
const Navbar = () => {
  ...
  return (
    <nav className="flex py-2 w-screen justify-between px-10 absolute z-10 top-0 left-0 items-center  backdrop-blur-sm ">
      {/* LOGO */}
      <button
      ...
      {/* MENU MOBILE SLIDE */}
      <div
        className={`fixed top-0 left-0 h-screen   max-w-xs bg-sky-900  text-white p-6 py-12 flex flex-col gap-6 uppercase font-bold transform transition-transform duration-300 ease-in-out z-20
